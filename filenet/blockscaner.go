...
func (bs *FNBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
func (bs *FNBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *FNBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
//@optional
func (bs *FNBlockScanner) SupportBlockchainDAI() bool {
	return true
}
